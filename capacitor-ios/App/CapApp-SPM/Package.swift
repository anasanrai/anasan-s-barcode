...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorBarcodeScanner", path: "../../../node_modules/.pnpm/@capacitor+barcode-scanner@3.1.2_@capacitor+core@8.5.0/node_modules/@capacitor/barcode-scanner"),
