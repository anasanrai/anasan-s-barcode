...
const strings = {
  en: {
    ...
    guidanceLowLight: "Low light — tap flash",
    guidanceGlare: "Adjust angle to reduce screen glare",
    guidanceBlurry: "Hold steady or move closer",
    guidanceTooBright: "Screen too bright — tilt angle",
    scanningLive: "SCANNING",
    lockingLive: "LOCKING...",
    lockedLive: "CONFIRMED",
  ...
  ar: {
    ...
    copied: "تم نسخ الرقم إلى الحافظة!",
    shareBarcode: "مشاركة الباركود",
    guidanceLowLight: "إضاءة ضعيفة — جرب الفلاش",
    guidanceGlare: "اضبط الزاوية لتفادي انعكاس الشاشة",
    guidanceBlurry: "ثبت الكاميرا أو اقترب أكثر",
    guidanceTooBright: "الشاشة ساطعة جداً — أمل الكاميرا",
    scanningLive: "جاري المسح",
    lockingLive: "جاري التثبيت...",
    lockedLive: "تم التأكيد",
    debugTelemetry: "بيانات الأداء",
    en: "EN",
    ar: "AR",
  },
} as const;
